...
const SECTIONS = {
  ...
  configuration: {
    ...
    keys: ["AZURE_TTS_REGION", "ANKI_CONNECT_URL", "DISTRIBUTION_TARGETS"] as ConfigKey[],
  },
  telegram: {
    title: "Telegram Bot",
...
const KEY_LABELS: Record<ConfigKey, string> = {
  ...
  DISTRIBUTION_TARGETS: "Distribution Targets",
};

const KEY_PLACEHOLDERS: Partial<Record<ConfigKey, string>> = {
  DISTRIBUTION_TARGETS: "Gao Tian=http://localhost:8770, Gao Yi=http://localhost:8771",
