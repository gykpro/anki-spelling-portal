...
- [x] **Claude Code Enrichment Skill** — Distributable skill in `.claude/skills/anki-enrich/` exposing the enrichment API as CLI scripts. Supports text enrichment, audio/image generation, full pipeline, and worksheet extraction. SKILL.md provides intent-to-script mapping for conversational use.
